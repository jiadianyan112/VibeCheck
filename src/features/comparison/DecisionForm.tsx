  ...
  if (existing) {
    return (
      <section id="comparison-decision" className="decision-complete wire-card stack" aria-labelledby="decision-complete-heading">
        <div className="cluster cluster--between"><h3 id="decision-complete-heading">决策记录已保存</h3><Tag tone="strong">仅自己可见</Tag></div>
  ...
  return (
    <section id="comparison-decision" className="decision-form-section stack" aria-labelledby="decision-form-heading">
      ...
      <form className="decision-form stack" onSubmit={submit}>
        ...
        <label className="choice-card choice-card--fixed"><input type="checkbox" checked readOnly /><span><strong>同时保存本次比较</strong><small>所选作品和这次决定会一起保存在个人中心。</small></span></label>
