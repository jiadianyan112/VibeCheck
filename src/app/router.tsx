...
const frontstageRoutes = routeCatalog
  ...
  .map((route) => {
    const page = route.id === 'P01' ? <ProjectsHomePage /> : route.id === 'P02' ? <CategoriesPage /> : route.id === 'P03' ? <CategoryDetailPage /> : route.id === 'P04' ? <ActivityPage /> : route.id === 'P05' ? <SearchPage /> : route.id === 'P06' ? <DiscoverPage /> : route.id === 'P07' ? <DiscoverResultPage /> : route.id === 'P08' ? <ProjectDetailPage /> : route.id === 'P09' ? <CompareSessionPage /> : route.id === 'P10' || route.id === 'P11' ? <PublishPage /> : route.id === 'P12' ? <AuthorVerificationPage /> : route.id === 'P13' ? <ProjectUpdatePage /> : route.id === 'P14' ? <CreatorProfilePage /> : route.id === 'P15' ? <PersonalCenterPage /> : route.id === 'P16' ? <NotificationsPage /> : route.id === 'P17' ? <AuthPage /> : route.id === 'P18' ? <AboutPage /> : <NotFoundPage />
    return {
      path: route.path,
...
const adminRoutes = routeCatalog
  ...
  .map((route) => ({
    path: route.path,
    element: route.id === 'A01' ? <AdminDashboardPage /> : route.id === 'A02' ? <AdminProjectsPage /> : route.id === 'A03' ? <AdminProjectEditorPage /> : route.id === 'A04' ? <AdminDuplicatesPage /> : route.id === 'A05' ? <AdminReviewsPage /> : route.id === 'A06' ? <AdminAuthorVerificationPage /> : route.id === 'A08' ? <Navigate to="/admin" replace /> : route.id === 'A09' ? <AdminStatusMonitorPage /> : <NotFoundPage />,
  }))
