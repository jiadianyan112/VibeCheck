...
export const routeCatalog: RouteCatalogItem[] = [
  ...
  { id: 'P06', name: '查同类意图确认', path: '/discover', area: 'frontstage', pendingModules: ['目标用户', '场景', '输入', '练习形式', '输出确认'] },
  { id: 'P07', name: '同类分析', path: '/discover/result', area: 'frontstage', pendingModules: ['方案分组', '状态分布', '代表作品', '资产分布'] },
