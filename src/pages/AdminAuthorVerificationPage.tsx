...
export function AdminAuthorVerificationPage() {
  ...
  return (
    <div className="admin-page stack">
      <header className="admin-page-header"><div><h1>作者身份审核</h1><p>材料只在此后台审核页显示；前台作品、动态、作者主页和公开证据抽屉均不读取私有材料引用。</p></div><Tag>{requests.filter((request) => request.status === 'pending').length} 项待审核</Tag></header>
