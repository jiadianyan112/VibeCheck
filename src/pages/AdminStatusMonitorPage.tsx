...
export function AdminStatusMonitorPage() {
  ...
  return (
    <div className="admin-page stack">
      <header className="admin-page-header"><div><h1>状态监测</h1><p>技术检查只生成观察信号。首次 URL 异常只进入待复查，不能直接推导暂停、结束或失败。</p></div><Tag tone="dashed">{candidates.length} 项异常信号</Tag></header>
