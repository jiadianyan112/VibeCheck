    ...
    <div className="admin-page stack">
      ...
      <div className="admin-editor-layout">
        ...
        <div className="admin-editor-main stack">
          ...
          <section id="assets" className="admin-editor-section stack"><div><h2>资产</h2></div><p>当前关联 {project.assetIds.length} 项资产；T48 仅显示引用，不在此无痕改写资产记录。</p><Link to={`/project/${project.id}#assets`}>在前台查看资产与可用性</Link></section>
          <section id="relations" className="admin-editor-section stack"><div><h2>关系</h2></div><p>当前关联 {project.relationIds.length} 条作品关系；确认状态和争议由专用流程维护。</p><Link to={`/project/${project.id}#relations`}>在前台查看关系</Link></section>
