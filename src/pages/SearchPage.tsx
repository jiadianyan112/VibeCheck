  ...
  return (
    <main className="page-container page-with-bottom-space stack">
      ...
      <section className="search-layout">
        <details className="filter-panel" aria-label="搜索筛选"><summary><span>筛选与排序</span><span aria-hidden="true">展开</span></summary><div className="filter-panel__body stack"><div className="cluster cluster--between"><h2>筛选</h2><Button variant="quiet" onClick={() => setParams({ q: query, mode }, { replace: true })}>重置</Button></div>
