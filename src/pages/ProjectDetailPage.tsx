  ...
  return (
    <main className="page-container page-with-bottom-space project-detail-page stack">
      ...
      <section className="project-hero">
        <div className="media-placeholder project-hero__media" aria-label="暂无公开图片">暂无公开图片</div>
      ...
      <section className="trust-variants stack" aria-labelledby="trust-variants-heading">
        <div className="section-heading cluster cluster--between"><div><h2 id="trust-variants-heading">作品信息与状态</h2></div><div className="cluster"><Link className="button button--quiet" to={`/submit?mode=supplement&project=${project.id}`}>补充作品信息</Link><details className="status-report-placeholder"><summary>状态说明</summary><p>提交后会进入人工核对，核对完成前不会更改当前状态。</p></details></div></div>
