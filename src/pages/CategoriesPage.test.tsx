...
describe('CategoriesPage', () => {
  ...
  it('keeps all eight learning topics and adds the portfolio category', async () => {
    ...
    expect(await screen.findByRole('heading', { name: '浏览分类' })).toBeInTheDocument()
    await screen.findByRole('heading', { name: '个人主页与作品集' })
  ...
  it('links every category to its topic detail and keeps technology secondary', async () => {
    ...
    expect(screen.getByText('选一个方向，发现同类作品。')).toBeInTheDocument()
